...
_CATEGORY_KEYWORDS: list[tuple[str, str]] = [
    ...
    # ── Electronics & Accessories (MUST be before fruits-vegetables to prevent
    #    "apple" matching Apple brand products as fruits) ──────────────────────
    # Apple brand products
    ("airpods", "electronics"),
    ("apple airpods", "electronics"),
    ("apple iphone", "electronics"),
    ("apple ipad", "electronics"),
    ("apple macbook", "electronics"),
    ("apple watch", "electronics"),
    ("apple charger", "electronics"),
    ("apple cable", "electronics"),
    ("apple lightning", "electronics"),
    ("apple usb-c", "electronics"),
    ("iphone", "electronics"),
    ("ipad", "electronics"),
    ("macbook", "electronics"),
    ("imac", "electronics"),
    ("apple tv", "electronics"),
    # Chargers & cables
    ("charger", "electronics"),
    ...
    ("data cable", "electronics"),
    ("fast charger", "electronics"),
    ("wall charger", "electronics"),
    ("car charger", "electronics"),
    ("wireless charger", "electronics"),
    # Other electronics brands & products
    ("samsung galaxy", "electronics"),
    ("samsung tab", "electronics"),
    ("oneplus", "electronics"),
    ("realme", "electronics"),
    ("redmi", "electronics"),
    ("poco phone", "electronics"),
    ("oppo phone", "electronics"),
    ("vivo phone", "electronics"),
    ("motorola moto", "electronics"),
    ("nokia phone", "electronics"),
    ("laptop", "electronics"),
    ("notebook computer", "electronics"),
    ("chromebook", "electronics"),
    ...
    ("sd card", "electronics"),
    ("trimmer", "electronics"),
    ("electric shaver", "electronics"),
    ("hair dryer", "electronics"),
    ("hair straightener", "electronics"),
    ("electric toothbrush", "electronics"),
    ("smart bulb", "electronics"),
    ("led strip", "electronics"),
    ("kindle", "electronics"),
    ("fire tablet", "electronics"),
    ("router wifi", "electronics"),
    ("wifi extender", "electronics"),
    ("boat rockerz", "electronics"),
    ("boat bassheads", "electronics"),
    ("jbl earphone", "electronics"),
    ("jbl headphone", "electronics"),
    ("sony earphone", "electronics"),
    ...
    ("syska", "electronics"),
    ("philips led", "electronics"),
    ("havells led", "electronics"),
    ...
    ("soyabean oil", "oils-spices"),
    ("groundnut oil", "oils-spices"),
    ("coconut oil", "oils-spices"),
    ("rice bran oil", "oils-spices"),
    ("cooking oil", "oils-spices"),
    ("edible oil", "oils-spices"),
    ("blended oil", "oils-spices"),
    ("oil", "oils-spices"),
    # ── Staples ──────────────────────────────────────────────────────────────
    ...
    ("heinz ketchup", "staples"),
    ("tomato ketchup", "staples"),
    ("tomato puree", "staples"),
    ("tomato paste", "staples"),
    ("tomato sauce", "staples"),
    ("tomato chutney", "staples"),
    ("tomato chilli", "staples"),
    ("tomato juice", "staples"),
    ("peeled tomato", "staples"),
    ("pizza sauce", "staples"),
    ("pasta sauce", "staples"),
    ("baked beans", "staples"),
    ...
    # ── Fruits & Vegetables ──────────────────────────────────────────────────
    # NOTE: "apple" bare keyword is intentionally REMOVED here to prevent
    # Apple brand electronics (AirPods, iPhone, chargers) from being
    # miscategorized as fruits. Use specific fruit-context phrases only.
    ("fresh onion", "fruits-vegetables"),
    ("red tomato", "fruits-vegetables"),
    ("banana robusta", "fruits-vegetables"),
    ("baby spinach", "fruits-vegetables"),
    ("shimla apple", "fruits-vegetables"),   # specific fruit variety
    ("kashmiri apple", "fruits-vegetables"),
    ("fuji apple", "fruits-vegetables"),
    ("green apple", "fruits-vegetables"),
    ("red apple", "fruits-vegetables"),
    ("fresh apple", "fruits-vegetables"),
    ("apple fruit", "fruits-vegetables"),
    ...
    # Processed/packaged products containing vegetable/fruit names → NOT produce
    ("onion pakoda", "snacks-drinks"),
    ("onion rings", "snacks-drinks"),
    ("onion namkeen", "snacks-drinks"),
    ("potato chips", "snacks-drinks"),
    ("potato sticks", "snacks-drinks"),
    ("potato wafers", "snacks-drinks"),
    ("potato fries", "snacks-drinks"),
    ("potato wedges", "snacks-drinks"),
    ("banana chips", "snacks-drinks"),
    ("banana wafers", "snacks-drinks"),
    ("raw banana chips", "snacks-drinks"),
    ("kerala banana chips", "snacks-drinks"),
    ("garlic bread", "bakery"),
    ("garlic butter", "dairy-breakfast"),
    ("garlic powder", "oils-spices"),
    ("garlic paste", "oils-spices"),
    ("garlic sauce", "oils-spices"),
    ("ginger paste", "oils-spices"),
    ("ginger powder", "oils-spices"),
    ("ginger garlic paste", "oils-spices"),
    ...
    ("kiwi fruit", "fruits-vegetables"),
    ("avocado", "fruits-vegetables"),
    ("strawberry", "fruits-vegetables"),
    ("blueberry", "fruits-vegetables"),
    ("guava", "fruits-vegetables"),
    ("jackfruit", "fruits-vegetables"),
    ("drumstick vegetable", "fruits-vegetables"),
    ("okra", "fruits-vegetables"),
    ("radish", "fruits-vegetables"),
    ("beetroot", "fruits-vegetables"),
    ("sweet potato", "fruits-vegetables"),
    ("pumpkin", "fruits-vegetables"),
    ("brinjal", "fruits-vegetables"),
...
def _detect_category(name: str, query: str = "", scraped_category: str = "") -> str:
    ...
    # NOTE: "electronics" is the actual DB slug (not "electronics-accessories")
    _VALID_CATS = {
        "dairy-breakfast", "fruits-vegetables", "snacks-drinks", "staples",
        "oils-spices", "household", "personal-care", "baby-care",
        "chicken-meat", "frozen-foods", "frozen-ready", "bakery",
        "pharma-wellness", "electronics", "electronics-accessories",
    }
...
async def fix_electronics_category(
    ...
    ELECTRONICS_KEYWORDS = [
        # Apple brand — MUST catch these before any fruit keyword matching
        "airpods", "apple airpods", "apple iphone", "apple ipad",
        "apple macbook", "apple watch", "apple charger", "apple cable",
        "apple lightning", "apple usb-c", "apple tv",
        "iphone", "ipad", "macbook", "imac",
        # Chargers & cables (key fix — these were landing in fruits-vegetables)
        "charger", "charging cable", "lightning cable", "type-c cable",
        "type c cable", "usb-c cable", "data cable", "fast charger",
        "wall charger", "car charger", "wireless charger",
        # Other phone brands
        "samsung galaxy", "samsung tab", "oneplus", "realme", "redmi",
        "poco phone", "oppo phone", "vivo phone", "motorola moto",
        "nokia phone", "asus rog",
        "laptop", "notebook computer", "chromebook",
        # Audio
        "earphones", "earbuds", "headphones", "bluetooth speaker",
        "boat rockerz", "boat bassheads", "jbl earphone", "jbl headphone",
        "sony earphone", "sony headphone",
        # Wearables & accessories
        "smartwatch", "fitness band", "mi band",
        "power bank", "usb cable", "screen protector",
        "phone case", "mobile cover", "back cover", "tempered glass",
        "kindle", "fire tablet",
        "router wifi", "wifi extender",
        "pen drive", "memory card", "sd card",
        # Appliances
        "trimmer", "electric shaver", "hair dryer", "hair straightener",
        "electric toothbrush", "smart bulb", "led strip",
    ]
