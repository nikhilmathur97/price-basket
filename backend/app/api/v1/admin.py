...
_CATEGORY_KEYWORDS: dict[str, list[str]] = {
    ...
    "staples":           ["basmati rice", "brown rice", "wheat flour", "atta", "maida",
                          ...
                          "urad dal", "masoor dal", "semolina", "sooji",
                          "poha", "oats", "cornflour", "rawa",
                          "noodles", "pasta", "maggi", "instant noodles", "ready to eat",
                          "instant soup", "cup noodles", "ramen", "upma mix", "porridge mix"],
    "oils-spices":       ["refined oil", "mustard oil", "sunflower oil", "olive oil",
                          "cooking oil", "groundnut oil", "sugar", "salt", "masala",
...
_CATEGORY_OVERRIDES: dict[str, list[str]] = {
    "snacks-drinks":     ["chips", "namkeen", "bhujia", "biscuit", "cookie", "wafer",
                          ...
                          "juice", "drink", "water", "tea", "coffee", "cola", "soda",
                          "shake", "smoothie", "squash", "syrup", "aerated"],
    "staples":           ["rice", "atta", "flour", "dal", "oats", "poha", "semolina",
                          "sooji", "rawa", "lentil", "noodles", "pasta", "maggi",
                          "instant", "ready to eat", "soup", "ramen", "upma", "porridge"],
    "oils-spices":       ["oil", "sugar", "salt", "masala", "turmeric", "spice"],
