...
# NOTE: keys here MUST exactly match real Category.slug values in the DB
# (dairy-breakfast, fruits-vegetables, snacks-drinks, bakery, staples, oils-spices,
# household, personal-care, chicken-meat, baby-care, frozen-foods, pet-care) — the
# taxonomy used to only exist inside this file (e.g. "dairy-eggs", "snacks", "beauty",
# "meat-seafood") and never matched a real category, so _detect_expected_category's
# own override-protection (keyed by current_slug) could never fire, and the fix
# endpoint's cat_map.get(expected_slug) silently skipped most "fixes".
_CATEGORY_KEYWORDS: dict[str, list[str]] = {
    # Coffee/tea/oats/honey/jam/bread/cornflakes belong here (not snacks-drinks/staples) —
    # this matches app/api/v1/setup.py's _detect_category, the actual logic used to
    # assign category_id at seed time. Keeping the two in sync avoids reintroducing
    # false positives (e.g. "Bournvita" or "Instant Oats" flagged as a mismatch simply
    ...
    "snacks-drinks":     ["chips", "biscuit", "cookie", "namkeen", "bhujia", "popcorn",
                          "wafer", "cracker", "snack", "puff", "pretzel", "nachos",
                          "banana chips", "potato chips", "tortilla", "murukku", "chivda",
                          "mixture", "mathri", "sev", "chakli", "fryums", "chocolate",
                          "noodles", "maggi",
                          "juice", "cola", "soda", "mineral water", "packaged water",
                          "energy drink", "lemonade", "squash", "syrup", "milkshake",
                          "smoothie", "cold drink", "soft drink", "aerated", "tonic water"],
    "staples":           ["basmati rice", "brown rice", "wheat flour", "atta", "maida",
                          "besan", "dal", "lentil", "toor dal", "moong dal", "chana dal",
                          "urad dal", "masoor dal", "semolina", "sooji", "sugar",
                          "poha", "cornflour", "rawa", "pasta",
                          "ready to eat", "instant soup", "cup noodles", "ramen",
                          "upma mix", "porridge mix"],
    "oils-spices":       ["refined oil", "mustard oil", "sunflower oil", "olive oil",
                          "cooking oil", "groundnut oil", "salt", "masala",
                          "turmeric", "chilli powder", "garam masala", "spice"],
    "personal-care":     ["shampoo", "conditioner", "face wash", "moisturizer", "body lotion",
                          ...
                          "lipstick", "mascara", "foundation", "blush", "kajal", "eyeliner",
    ...
    "frozen-foods":      ["frozen", "ice cream", "gelato", "sorbet", "popsicle",
    ...
    "chicken-meat":      ["chicken", "mutton", "fish fillet", "prawn", "shrimp",
...
# e.g. "banana chips" in snacks-drinks should NOT be flagged as fruits-vegetables.
# Keys MUST exactly match real Category.slug values (see note above).
_CATEGORY_OVERRIDES: dict[str, list[str]] = {
    "snacks-drinks":     ["chips", "namkeen", "bhujia", "biscuit", "cookie", "wafer",
                          "cracker", "puff", "popcorn", "snack", "murukku", "mixture",
                          "mathri", "sev", "chivda", "fryums", "pretzel", "nachos",
                          "chocolate", "noodles", "maggi",
                          "juice", "drink", "water", "cola", "soda",
                          "shake", "smoothie", "squash", "syrup", "aerated"],
    "staples":           ["rice", "atta", "flour", "dal", "poha", "semolina", "sugar",
                          "sooji", "rawa", "lentil", "pasta",
                          "ready to eat", "soup", "ramen", "upma", "porridge"],
    ...
    "chicken-meat":      ["chicken", "mutton", "fish", "prawn", "shrimp", "beef",
