...
class AppConfig {
  // ── URLs ──────────────────────────────────────────────────────────────────
  // ✅ PRODUCTION — app points to the live production environment.
  // To test against staging, swap the two lines below (comment prod, uncomment dev).
  static const String baseUrl = 'https://pricebasket.in'; // PRODUCTION
