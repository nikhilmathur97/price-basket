...
import { ShieldCheck, Users, Receipt, MessageSquare, Store, BarChart3, Home, Database, ShoppingBag, Activity, LayoutGrid, TrendingUp, Search, Megaphone, Crown, Radar, MessageSquareWarning } from "lucide-react";
import { useAuthStore } from "@/store/authStore";

const NAV = [
  { href: "/admin", label: "Overview", icon: ShieldCheck },
  { href: "/admin/executive", label: "Executive", icon: Crown },
