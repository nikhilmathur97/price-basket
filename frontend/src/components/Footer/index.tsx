          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 text-surface-400 hover:text-pink-400 text-xs transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-surface-400 hover:text-green-400 text-xs transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
