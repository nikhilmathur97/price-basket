...
export const metadata: Metadata = {
  title: "Grocery Prices in Kolkata 2026 — Compare & Save",
  description:
    "Compare grocery prices in Kolkata across Blinkit, Zepto, Instamart, BigBasket & JioMart. Find the cheapest grocery delivery in Kolkata. Free price alerts.",
  keywords: [
