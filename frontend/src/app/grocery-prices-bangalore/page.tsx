...
export const metadata: Metadata = {
  title: "Grocery Prices in Bangalore 2026 — Compare & Save",
  description:
    "Compare grocery prices in Bangalore across Blinkit, Zepto, Instamart, BigBasket & JioMart. Find the cheapest grocery delivery in Bangalore. Free price alerts.",
  keywords: [
