...
export const metadata: Metadata = {
  title: "Grocery Prices in Delhi 2026 — Compare & Save",
  description:
    "Compare grocery prices in Delhi across Blinkit, Zepto, Instamart, BigBasket & JioMart. Find the cheapest grocery delivery in Delhi. Free price alerts.",
  keywords: [
