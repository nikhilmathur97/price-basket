...
export const metadata: Metadata = {
  title: "Grocery Prices in Ahmedabad 2026 — Compare & Save",
  description:
    "Compare grocery prices in Ahmedabad across Blinkit, Zepto, Instamart, BigBasket & JioMart. Find the cheapest grocery delivery in Ahmedabad. Free price alerts.",
  keywords: [
