...
export const metadata: Metadata = {
  title: "Cheapest Sugar Online Price 2026 — Compare & Save",
  description:
    "Compare sugar prices across Blinkit, Zepto, BigBasket, JioMart, Instamart. Refined, raw, brown sugar — find the cheapest sugar online in India. Free.",
  keywords: [
