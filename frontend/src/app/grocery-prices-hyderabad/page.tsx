...
export const metadata: Metadata = {
  title: "Grocery Prices in Hyderabad 2026 — Compare & Save",
  description:
    "Compare grocery prices in Hyderabad across Blinkit, Zepto, Instamart, BigBasket & JioMart. Find the cheapest grocery delivery in Hyderabad. Free price alerts.",
  keywords: [
