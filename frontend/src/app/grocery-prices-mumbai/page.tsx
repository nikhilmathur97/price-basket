...
export const metadata: Metadata = {
  title: "Grocery Prices in Mumbai 2026 — Compare & Save",
  description:
    "Compare grocery prices in Mumbai across Blinkit, Zepto, Instamart, BigBasket & JioMart. Find the cheapest grocery delivery in Mumbai. Free price alerts.",
  keywords: [
