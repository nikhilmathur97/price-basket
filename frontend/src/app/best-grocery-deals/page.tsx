...
export const metadata: Metadata = {
  title: "Best Grocery Deals India 2026 — Compare & Save",
  description:
    "Find the best grocery deals across Blinkit, Zepto, Instamart, BigBasket & JioMart. Compare live prices and save up to ₹500/month. Free.",
  keywords: [
