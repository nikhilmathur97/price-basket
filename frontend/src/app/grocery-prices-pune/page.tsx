...
export const metadata: Metadata = {
  title: "Grocery Prices in Pune 2026 — Compare & Save",
  description:
    "Compare grocery prices in Pune across Blinkit, Zepto, Instamart, BigBasket & JioMart. Find the cheapest grocery delivery in Pune. Free price alerts.",
  keywords: [
    "grocery prices pune",
