...
export async function generateMetadata({
  ...
  const title = `${m.a.name} vs ${m.b.name}: Which is Cheaper?`;
  const description = `Compare ${m.a.name} vs ${m.b.name} prices live across major Indian cities. Find the cheapest option and get free price alerts on PriceBasket.`;
